...
<template>
  <div>
    ...
    <div class="good">
      <header class="good-header">所有商品</header>
      <van-skeleton title :row="2" :loading="state.loading">
        <div class="good-box">
...
import { getHome ,getGoods} from '@/service/home'
...
<style lang="less" scoped >
  ...
  .good {
    .good-header {
      background: rgba(255, 240, 248, 255);
      height: 50px;
      line-height: 50px;
      text-align: left;
      color: @primary;
