    ...
    <div class="content">
      <van-pull-refresh v-model="state.refreshing" @refresh="onRefresh" class="product-list-refresh">
        ...
        >
          ...
          <img class="empty" v-else src="https://ts1.cn.mm.bing.net/th/id/R-C.261be710ededa54d91c3056614ccd871?rik=WNP%2fkY7xOrUCrQ&riu=http%3a%2f%2fwww.haitaoit.com%2fupload%2f201703%2f03%2f201703030923058869.jpg&ehk=6N1tYdxYivQmHDudGYCKoza37q85VLhyof0lgajmeNM%3d&risl=&pid=ImgRaw&r=0" alt="搜索">
        </van-list>
      </van-pull-refresh>
    </div>
  </div>
